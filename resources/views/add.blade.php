...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">{{ __('Add appointment') }}</div>
                    ...
                    <form method="POST" action="/appointment">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="address" type="text" class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" value="{{ old('city') }}" required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="start_time" type="text" class="form-control{{ $errors->has('start_date') ? ' is-invalid' : '' }}" name="start_time" value="{{ old('start_time') }}" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="end_date" type="text" class="form-control{{ $errors->has('end_date') ? ' is-invalid' : '' }}" name="end_date" value="{{ old('end_date') }}" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="end_time" type="text" class="form-control{{ $errors->has('end_time') ? ' is-invalid' : '' }}" name="end_time" value="{{ old('end_time') }}" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="kilometers" type="text" class="form-control{{ $errors->has('kilometers') ? ' is-invalid' : '' }}" name="kilometers" value="{{ old('kilometers') }}" autofocus>
